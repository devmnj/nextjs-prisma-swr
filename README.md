...
This is a Nextjs/React + Prisma ORM example using SWR module for data caching. SWR allow us to fast loading data between components and they are amazingly fast.

## Modules used
* Nextjs-cors
* [Prisma]([''](https://www.prisma.io/))
* Sqlite
* [Vercel-SWR](https://swr.vercel.app/docs/getting-started)
